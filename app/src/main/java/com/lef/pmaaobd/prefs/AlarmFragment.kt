...
import com.lef.pmaaobd.datastore.Operation
import com.lef.pmaaobd.datastore.Screen
import com.lef.pmaaobd.datastore.UserPreferenceOrBuilder
import com.lef.pmaaobd.stats.R
import com.lef.pmaaobd.ui.AppTheme
...
val Operation.op: String
    get() {
        return this.valueDescriptor.options.getExtension(com.lef.pmaaobd.datastore.UserPrefs.op)
    }
