...
import com.lef.pmaaobd.datastore.Coloring
import com.lef.pmaaobd.datastore.MaxControl
import com.lef.pmaaobd.prefs.SettingsViewModel
import com.lef.pmaaobd.stats.databinding.FragmentGaugeBinding
import com.lef.pmaaobd.utils.AwareObserver
...
class ObdGauge : Fragment() {

    private var rootView: View? = null
    private val mClock: ObdSpeedometer
        get() {
            return binding.dial
        }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putFloat("obdMin", binding.minValue)
        outState.putFloat("obdMax", binding.maxValue)
    ...
    fun setupClock(data: ObdData) {
        ...
        // get min/max values and unit from obd
    ...
    private fun onUpdate(data: ObdData) {
        val fVal = data.lastData.toFloat()
        mClock.speedTo(fVal, ObdRefresher.REFRESH_INTERVAL)
        mRayClock.speedTo(fVal, ObdRefresher.REFRESH_INTERVAL)
